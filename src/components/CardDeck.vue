<template>
  ...
  >
    <div class="deckCard" :class="[{ reduced: reducedMotion }, deckDirectionClass]" @click="flipNext">
      <span class="deckAura" aria-hidden="true"></span>
      <span class="deckShine" aria-hidden="true"></span>
...
const deckDirectionClass = computed(() => (direction.value === 'prev' ? 'flip-dir-prev' : 'flip-dir-next'));
