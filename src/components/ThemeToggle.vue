...
type ThemeKey = 'pro' | 'spring' | 'summer' | 'autumn' | 'winter' | 'mocking';
...
onMounted(() => {
  try {
    ...
    if (saved.theme && ['pro', 'spring', 'summer', 'autumn', 'winter', 'mocking'].includes(saved.theme)) {
      theme.value = saved.theme as ThemeKey;
    }
